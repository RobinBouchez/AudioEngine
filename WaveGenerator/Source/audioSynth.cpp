...
//}
//
//void AudioSynth::initialize(void *instance, ysContextObject::DeviceAPI api) {
...
//}
//
//void AudioSynth::process(float frame_dt) {
...
//}
//
//float AudioSynth::pixelsToUnits(float pixels) const {
//    const float f = m_displayHeight / m_engineView->m_bounds.height();
//    return pixels * f;
//}
//
//float AudioSynth::unitsToPixels(float units) const {
...
//}
//
//void AudioSynth::drawGeneratedUi(
//    const GeometryGenerator::GeometryIndices &indices,
//    int layer)
//{
...
//}
//
//void AudioSynth::createObjects(Engine *engine) {
